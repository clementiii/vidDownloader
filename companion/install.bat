...
powershell -Command "(Get-Content '%INSTALL_DIR%\viddownloader.json') -replace 'C:\\\\viddownloader\\\\viddownloader_companion.bat', '%INSTALL_DIR:\=\\%\\viddownloader_companion.bat' | Set-Content '%INSTALL_DIR%\viddownloader.json'"
...
echo 2. The companion app is ready to handle downloads!
echo.
pause
